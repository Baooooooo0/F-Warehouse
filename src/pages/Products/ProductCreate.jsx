        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-black tracking-[-0.033em] leading-tight text-slate-900">Add New Product</h1>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Inventory Management &gt; Products &gt; New</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h2 className="text-lg font-bold mb-1 text-slate-900">Basic Information</h2>
                  <p className="text-slate-500 text-sm">Enter the primary details for the product identification.</p>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium text-slate-700">Barcode (ISBN/UPC)</label>
                    <div className="relative group">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className="text-slate-500 text-sm">Upload images or videos of the product.</p>
                </div>
                <button type="button" className="text-primary text-sm font-bold hover:underline flex items-center gap-1">
                  <span className="material-symbols-outlined text-[16px]">download</span> Guidelines
                </button>
              </div>
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:border-primary hover:bg-primary/5 transition-all cursor-pointer group bg-gray-50">
                ...
                <p className="text-lg font-bold text-slate-900 mb-1">Click to upload or drag and drop</p>
                <p className="text-slate-500 text-sm font-medium">SVG, PNG, JPG or GIF (max. 800x400px)</p>
              </div>
            ...
            {/* Pricing Information */}
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <h2 className="text-lg font-bold mb-6 text-slate-900">Pricing Information</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-medium text-slate-700">Cost Price (COGS)</label>
                  <div className="relative group">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-bold group-focus-within:text-primary transition-colors">$</span>
                    <input 
                      name="costPrice"
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-3.5 rounded-lg border border-gray-200 bg-gray-50">
                  <div className="flex flex-col">
                    <span className="text-sm font-bold text-slate-900">Active Status</span>
                    <span className="text-xs text-slate-500">Product visibility on store</span>
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <option>Distribution Center (CA)</option>
                      <option>Outlet Store (TX)</option>
                    </select>
                ...
                {/* Supplier */}
                <div>
                  <h3 className="text-sm font-medium text-slate-700 mb-3">Supplier</h3>
